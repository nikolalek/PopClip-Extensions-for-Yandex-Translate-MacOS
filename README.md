...
![PopClip Extension](screenshots/popclip-bar.png)
...
1. Copy the content from [`YandexTranslate.snippet`](YandexTranslate.snippet)
...
![Extension Options](screenshots/extension-options.png)
...
- [`YandexTranslate.snippet`](YandexTranslate.snippet) - Main extension code
